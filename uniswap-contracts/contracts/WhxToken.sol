...
contract WhxToken is Initializable {
    /// @notice EIP-20 token name for this token
    string public constant name = "Whale Harvest xToken";

    /// @notice EIP-20 token symbol for this token
    string public constant symbol = "WHX";

    /// @notice EIP-20 token decimals for this token
    uint8 public constant decimals = 18;

    /// @notice Total number of tokens in circulation
    uint public constant totalSupply = 10000000e18; // 10 million WHX
    ...
    /**
     * @notice Initialize a new WHX token
